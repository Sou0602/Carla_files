...
class World(object):
    ...
    def restart(self, args):
        ...
        # altered to set vehicle
        blueprint = self.world.get_blueprint_library().filter(self._actor_filter)[args.vehicle]
...
def game_loop(args):
    ...
    try:
        ...
        while True:
            ...
            # altered to stop recording after specified time duration
...
def main():
    ...
    argparser.add_argument(
        ...
        default=None,
        type=int)
    # altered to include vehicle and duration arguments
    argparser.add_argument(
        '-vn', '--vehicle',
        help='Set the vehicle by specifying the vehicle number',
        default=0,
        type=int)
    argparser.add_argument(
        '-d', '--duration',
        help='Set the duration of recording in seconds (default: 60)',
        default= 60,
        type=int)
